"""
Feedback Available Email Builder
"""
...
class FeedbackBuilder(EmailBuilder):
    def __init__(self, message: Message):
        # Check message type is FEEDBACK_MESSAGE
        if message.get_type() != MessageType.FEEDBACK_MESSAGE:
            raise ValueError("System Error:Message type is not FEEDBACK_MESSAGE")
